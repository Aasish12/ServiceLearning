...
ssh -i "$SD103_PEM_PATH" ubuntu@128.31.25.49 'sudo pkill standalone; sudo pkill java; sudo rm ServiceLearning.BackEnd-1.0.jar; sudo java -jar ~/ServiceLearning.BackEnd-1.0.jar -b'
set +x